...
class MascotRenderer:
    ...
    def greeting(self) -> str:
        return _say(FACE_CURIOUS, "fatcat at your service.")
    ...
    def cleared(self, count: int, summary: str) -> str:
        noun = "store" if count == 1 else "stores"
        return _say(FACE_IDLE, f"Cleared {count} {noun}: {summary}. Fresh start.")
