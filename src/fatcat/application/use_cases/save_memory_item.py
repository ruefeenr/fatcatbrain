"""Use case: directly save a memory item (the low-friction ``fcat save`` path).
...
from fatcat.application.ports import MemoryRepository, RawInputRepository
from fatcat.domain.models import MemoryItem, RawInput
